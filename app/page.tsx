...
const PROFILE = {
  ...
  github: "https://github.com/abdullah-tariq", // optional, change or remove
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section id="about" className="max-w-6xl mx-auto px-4 md:px-6 py-16">
        <SectionHeader
          ...
          blurb="Thirty countries travelled, multi-industry experience (retail, events, data-centre), and now translating that grit into cloud and data value."
        />
      ...
      <section id="projects" className="max-w-6xl mx-auto px-4 md:px-6 py-16">
        <SectionHeader
          kicker="Projects"
          title="Selected work"
          blurb="Curated highlights with measurable outcomes and clean documentation."
        />
          ...
          {PROJECTS.map((p) => (
            <Card key={p.title}>
              <div className="flex items-start justify-between gap-4">
                ...
                <a
                  href="#"
                  className="text-indigo-600 inline-flex items-center gap-1 text-sm"
                >
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-semibold">{EDUCATION[0].title}</span>
            </div>
            <div className="text-sm text-slate-500">
              {EDUCATION[0].org} — {EDUCATION[0].period}
            </div>
            <p className="mt-3 text-slate-700">
              Focus: analytics, AI, cloud, and ethical tech. Distinction-level
              writing and stakeholder-ready deliverables.
            </p>
          </Card>
        </div>
      </section>
            ...
            <div className="md:col-span-2">
              ...
              <form className="grid sm:grid-cols-2 gap-4">
                ...
                <textarea
                  ...
                  className="border rounded-xl px-3 py-2 sm:col-span-2 h-28"
                />
                <button
                  type="button"
                  className="inline-flex items-center justify-center gap-2 bg-indigo-600 text-white px-5 py-2.5 rounded-xl hover:bg-indigo-700"
                >
      ...
      <footer className="py-10 text-center text-sm text-slate-500">
        © {new Date().getFullYear()} {PROFILE.name}. Crafted with ❤️ in
        Melbourne.
      </footer>
    </div>
  );
